...
public class DeleteMenuServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Drink d : menuList) { //เป็นการวนลูปหาใน menuList ว่า บรรทัดไหนมี id ตรงกับที่เราคลิกลบ ถ้ามันตรงก็จะจบบรรทัดที่มี id นั้น,, d: menuList คือเอาข้อมูลใน menuList ไปใส่ไว้ในตัวแปร d 
			if (d.getID() == id ) {
				drinkToRemove = d ;
				break;
			}
